                ...
                : Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text('Last saved pictures', style: boldTextStyle(size: 18, letterSpacing: 0.3, wordSpacing: 0.5,color: Colors.white)),
                          Text('View All', style: primaryTextStyle(color: Colors.white),).onTap(
                            () async {
                              if (!disableAdMob) {
                                if (isAds == isGoogleAds) {
